...
"[project]/src/context/auth.context.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AuthProvider = ({ children })=>{
    ...
    const login = async (payload)=>{
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post('/auth/login', payload);
        setUser(data.user);
        setRole(data.user.role);
        router.push(`/${data.user.role}`);
    };
    const logout = async ()=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post('/auth/logout');
        setUser(null);
        setRole(null);
        router.push('/login');
    };
    const fetchMe = async ()=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get('/auth/me');
            setUser(data.user);
            setRole(data.user.role);
        } catch  {
            setUser(null);
...
_s(AuthProvider, "SXxfh4sLcZNCZSpELAI+DoRbHc0=", false, function() {
    return [
...
"[project]/src/constants/palettes.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/context/theme.context.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const [palette, setPalette] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "ThemeProvider.useState": ()=>{
            try {
                ...
                return p ? JSON.parse(p) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$palettes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PALETTES"].blue;
            } catch (e) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$palettes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PALETTES"].blue;
            }
        }
    }["ThemeProvider.useState"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(ThemeProvider, "ibjR1mokyZnAXq29MGcMS0s+kNY=");
_c = ThemeProvider;
const useTheme = ()=>{
    _s1();
...
//# sourceMappingURL=src_fe24d22b._.js.map