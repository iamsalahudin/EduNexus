...
"[project]/src/context/auth.context.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AuthProvider = ({ children })=>{
    ...
    const login = async (payload)=>{
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/auth/login', payload);
        setUser(data.user);
        setRole(data.user.role);
        router.push(`/${data.user.role}`);
    };
    const logout = async ()=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/auth/logout');
        setUser(null);
        setRole(null);
        router.push('/login');
    };
    const fetchMe = async ()=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get('/auth/me');
            setUser(data.user);
            setRole(data.user.role);
        } catch  {
            setUser(null);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        fileName: "[project]/src/context/auth.context.js",
        lineNumber: 49,
        columnNumber: 5
...
"[project]/src/constants/palettes.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const PALETTES = {
    blue: {
        primary: '220 90% 56%',
        secondary: '260 80% 60%',
        textLightBg: '222 47% 11%',
        textDarkBg: '210 40% 96%',
        cta: '142 76% 36%'
    },
    emerald: {
        primary: '160 84% 39%',
...
"[project]/src/context/theme.context.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ThemeProvider = ({ children })=>{
    ...
    const [palette, setPalette] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
        try {
            const p = localStorage.getItem('theme-palette');
            return p ? JSON.parse(p) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$palettes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PALETTES"].blue;
        } catch (e) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$palettes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PALETTES"].blue;
        }
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ThemeContext.Provider, {
        ...
        fileName: "[project]/src/context/theme.context.js",
        lineNumber: 65,
        columnNumber: 5
    }, ("TURBOPACK compile-time value", void 0));
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__29d2031c._.js.map