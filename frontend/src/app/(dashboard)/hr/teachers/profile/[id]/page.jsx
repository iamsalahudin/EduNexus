  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        right={<div className="flex gap-2"><ButtonLink href="/hr/teachers" variant="secondary">Back</ButtonLink><ButtonLink href={`/hr/teachers/edit/${id}`} variant="primary">Edit</ButtonLink><Button type="button" variant="danger" onClick={handleDelete} disabled={deleting || loading}>{deleting ? 'Deleting...' : 'Delete'}</Button></div>}
      />
