      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
                        ...
                        <TableRow key={row._id} className="hover:bg-gray-50">
                          ...
                          <TableCell>
                            <div className="flex gap-2">
                              <ButtonLink href={`/hr/teachers/profile/${row._id}`} variant="outline" size="sm">View</ButtonLink>
                              <ButtonLink href={`/hr/teachers/edit/${row._id}`} variant="outline" size="sm">Edit</ButtonLink>
                            </div>
                          </TableCell>
                        </TableRow>
                      ))}
        ...
        <Card>
          ...
          <div className="mt-4 grid grid-cols-1 gap-2">
            <ButtonLink href="/hr/teachers/add" variant="secondary" className="w-full">Add New Teacher</ButtonLink>
          </div>
