    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        ...
        <div className="gap-2 hidden">
          <Link href="/Finance/fees" className="px-3 py-2 btn-primary rounded">Fees</Link>
          <Link href="/Finance/attendance" className="px-3 py-2 border rounded">Attendance</Link>
        </div>
      </div>
