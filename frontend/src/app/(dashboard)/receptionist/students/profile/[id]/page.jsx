  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="View enrollment, account, parent, and transport records."
        right={(
          <div className="flex flex-wrap gap-2">
            <ButtonLink href="/receptionist/admissions" variant="secondary">Back</ButtonLink>
            <ButtonLink href={`/receptionist/students/edit/${id}`} variant="primary">Edit</ButtonLink>
          </div>
        )}
      />
