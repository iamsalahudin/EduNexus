      ...
      <PageHeader
        ...
        right={(
          <div className="flex flex-wrap gap-2">
            <ButtonLink href="/principal/notifications/send" variant="primary">Send</ButtonLink>
            <ButtonLink href="/principal/notifications/history" variant="outline">History</ButtonLink>
          </div>
        )}
      />
