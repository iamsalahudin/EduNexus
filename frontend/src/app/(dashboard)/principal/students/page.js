                            ...
                            <TableRow key={row._id} className="hover:bg-gray-50">
                              ...
                              <TableCell>
                                <div className="flex flex-wrap gap-2">
                                  <ButtonLink href={`/principal/students/profile/${row._id}`} variant="outline" size="sm">View</ButtonLink>
                                  <ButtonLink href={`/principal/students/edit/${row._id}`} variant="outline" size="sm">Edit</ButtonLink>
                                  <ButtonLink href={`/principal/students/transfer-certificate?studentId=${row._id}`} variant="outline" size="sm">TC</ButtonLink>
                                  <ButtonLink href={`/principal/students/school-leaving-certificate?studentId=${row._id}`} variant="outline" size="sm">SLC</ButtonLink>
                                </div>
                              </TableCell>
                            </TableRow>
                          ))}
