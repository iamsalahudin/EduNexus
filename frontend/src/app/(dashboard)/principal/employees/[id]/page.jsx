  ...
  return (
    <div>
      <PageHeader
        ...
        right={<div className="flex gap-2"><ButtonLink href="/principal/employees" variant="secondary">Back</ButtonLink><ButtonLink href={`/principal/employees/${id}/edit`} variant="primary">Edit Employee</ButtonLink></div>}
      />
