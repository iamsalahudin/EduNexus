...
export default function AddEmployeePage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setTimeout(() => router.push('/principal/employees'), 1200)
    } catch (err) {
  ...
  return (
    <div>
      <PageHeader
        ...
        right={<ButtonLink href="/principal/employees" variant="secondary">Back</ButtonLink>}
      />
      ...
      <div className="mt-6">
        {loading ? <Skeleton className="h-96" /> : (
          <EmployeeForm
            ...
            onCancel={() => router.push('/principal/employees')}
