...
const ROLE_OPTIONS = ['', 'Teacher', 'Student', 'Parent', 'HR', 'Finance', 'Reception']
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        right={
          <ButtonLink href="/principal/users/add" variant="primary">
            Add User
          </ButtonLink>
        }
      />
                      ...
                      <TableRow key={userId} className="hover:bg-gray-50">
                        ...
                        <TableCell>
                          <div className="flex gap-2">
                            ...
                            {u.role !== 'Admin' ? (
                              <ButtonLink href={`/principal/users/update?id=${encodeURIComponent(userId)}`} variant="outline" size="sm">
                                Edit
                              </ButtonLink>
                            ) : null}
                          </div>
