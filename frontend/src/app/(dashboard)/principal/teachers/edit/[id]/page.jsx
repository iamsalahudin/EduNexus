  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        right={<ButtonLink href="/principal/teachers" variant="secondary">Back</ButtonLink>}
      />
        ...
        <Card>
          <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={onSubmit}>
            ...
            <div className="md:col-span-2 flex gap-2">
              ...
              <ButtonLink href={`/principal/teachers/profile/${id}`} variant="secondary">View Profile</ButtonLink>
            </div>
          </form>
        </Card>
      )}
