  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        right={<div className="flex gap-2"><ButtonLink href="/principal/teachers" variant="secondary">Back</ButtonLink><ButtonLink href={`/principal/teachers/edit/${id}`} variant="primary">Edit</ButtonLink><Button type="button" variant="danger" onClick={handleDelete} disabled={deleting || loading}>{deleting ? 'Deleting...' : 'Delete'}</Button></div>}
      />
