...
export default function FeesHome(){
  ...
  return (
    <div>
      <PageHeader
        title="Fees"
        subtitle="Manage fee collection, records, defaulters, and reports."
        right={(
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <p className="text-sm text-gray-600 mt-2">Use finance pages for monitoring aggregated incoming fee and pending liability trends.</p>
          <div className="mt-4 flex gap-3 flex-wrap">
            <ButtonLink href="/principal/finance/income" variant="outline">Income Reference</ButtonLink>
            <ButtonLink href="/principal/finance/reports" variant="outline">Finance Reports</ButtonLink>
          </div>
        </Card>
      </div>

      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-3">
        <ButtonLink href="/principal/fees/collection" variant="primary">Fee Collection</ButtonLink>
        <ButtonLink href="/principal/fees/record" variant="primary">Past Fee Records</ButtonLink>
        <ButtonLink href="/principal/fees/defaulters" variant="outline">Defaulters</ButtonLink>
        <ButtonLink href="/principal/fees/report" variant="outline">Fee Reports</ButtonLink>
      </div>
    </div>
  )
}
