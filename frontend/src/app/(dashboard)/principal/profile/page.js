...
export default function Page() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="My Profile"
        subtitle="View your personal information and leadership details."
      />
        ...
        <Card className="md:col-span-2">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t">
              <a href="/principal/profile/edit" className="px-4 py-2 bg-primary text-white rounded hover:bg-primary-dark">
                Edit Profile
              </a>
            </div>
          </div>
