    ...
    <div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <ButtonLink href="/principal/attendance/daily" variant="primary" className="w-full">
            View Daily
          </ButtonLink>
        </Card>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <ButtonLink href="/principal/attendance/class" variant="primary" className="w-full">
            View Classes
          </ButtonLink>
        </Card>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <ButtonLink href="/principal/attendance/teachers/reports" variant="primary" className="w-full">
            Open Reports
          </ButtonLink>
        </Card>
