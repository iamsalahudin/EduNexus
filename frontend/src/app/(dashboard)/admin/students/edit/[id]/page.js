  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        right={<ButtonLink href="/admin/students" variant="secondary">Back</ButtonLink>}
      />
        ...
        <Card>
          <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={onSubmit}>
            ...
            <div className="md:col-span-2 flex flex-col sm:flex-row gap-2">
              ...
              <ButtonLink href={`/admin/students/profile/${id}`} variant="secondary" className="w-full sm:w-auto">
                View Profile
              </ButtonLink>
            </div>
          </form>
