      ...
      <PageHeader
        ...
        right={(
          <div className="flex flex-wrap gap-2">
            <ButtonLink href="/admin/students" variant="secondary">Back</ButtonLink>
            <ButtonLink href={`/admin/students/edit/${id}`} variant="primary">Edit</ButtonLink>
            <ButtonLink href={`/admin/students/transfer-certificate?studentId=${id}`} variant="outline">Issue TC</ButtonLink>
            <ButtonLink href={`/admin/students/school-leaving-certificate?studentId=${id}`} variant="outline">Issue SLC</ButtonLink>
