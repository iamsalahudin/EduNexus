      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-4">
        <Card className="lg:col-span-1">
          ...
          <div className="mt-4 grid grid-cols-1 gap-2">
            <Button type="button" variant="primary" onClick={() => (window.location.href = '/admin/exams/marks-entry')}>
              Marks Entry
            </Button>
            <Button type="button" onClick={() => (window.location.href = '/admin/exams/schedule')}>
