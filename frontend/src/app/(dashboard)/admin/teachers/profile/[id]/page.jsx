  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        setError(
          err?.response?.data?.error || "Failed to load teacher profile",
        );
      } finally {
        setLoading(false);
      }
      ...
      <PageHeader
        ...
        right={
          <div className="flex gap-2">
            <ButtonLink href="/admin/teachers" variant="secondary">
              Back
            </ButtonLink>
            <ButtonLink href={`/admin/teachers/edit/${id}`} variant="primary">
              Edit
            </ButtonLink>
            <Button
              type="button"
        ...
        <>
          <Card>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              ...
              <div>
                <span className="text-gray-500">Emergency Name:</span>{" "}
          ...
          <Card>
            ...
            <p className="text-xs text-gray-600 mt-1">
              This will be updated from timetable configuration. Until then, it
              may remain empty.
            </p>

            {assignmentRows.length === 0 ? (
              <div className="text-sm text-gray-600 mt-3">
                No class-subject assignments available yet.
              </div>
            ) : (
