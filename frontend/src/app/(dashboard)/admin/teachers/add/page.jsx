...
export default function AddTeacherPage() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      setTimeout(() => {
        router.push(`/admin/teachers/profile/${teacher?._id}`)
      }, 600)
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        right={<ButtonLink href="/admin/teachers" variant="secondary">Back</ButtonLink>}
      />
      ...
      <Card>
        <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={onSubmit}>
          ...
          <div className="md:col-span-2 flex gap-2">
            ...
            <ButtonLink href="/admin/teachers" variant="secondary">Cancel</ButtonLink>
          </div>
        </form>
      </Card>
    </div>
