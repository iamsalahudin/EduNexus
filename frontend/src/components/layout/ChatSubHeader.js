      ...
      <div className="w-full px-6 flex items-center justify-between">
        <div className="flex items-center gap-3 min-w-0">
          <button
            ...
            className="lg:hidden px-2 py-1 border rounded nav-item inline-flex items-center gap-2"
        ...
        <div>
          <button
            className="text-xs px-2 py-1 rounded-md border hover:bg-[var(--color-primary)] hover:text-white transition"
