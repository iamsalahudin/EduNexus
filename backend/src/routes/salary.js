...
router.get('/summary', requireRole('Admin', 'Principal', 'HR', 'Reception', 'Finance', 'Teacher'), salaryController.getSalarySummary)
...
router.get('/staff', requireRole('Admin', 'Principal', 'HR', 'Finance'), salaryController.listSalaryStaff)
router.get('/staff/:id', requireRole('Admin', 'Principal', 'HR', 'Finance'), salaryController.getSalaryStaff)
...
router.get('/records', requireRole('Admin', 'Principal', 'HR', 'Reception', 'Finance', 'Teacher'), validate(salaryReportSchema), salaryController.listSalaryRecords)
...
router.get('/reports', requireRole('Admin', 'Principal', 'HR', 'Finance', 'Reception'), validate(salaryReportSchema), salaryController.getSalaryReports)
